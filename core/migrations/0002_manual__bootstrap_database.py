"""
Manual migration: bootstrap database

- GIN indexes on distillation_sv and full_content_sv
- Trigger to auto-populate both search vectors on insert/update

Note: pgvector extension must be installed at the OS level before use:
