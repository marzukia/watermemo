...
class BaseMemory(models.Model):
    """Abstract base for all memory types. Provides content, FTS vector, and embedding fields."""
...
class DistillationManager(models.Manager):
    def distill(self, memory: Memory) -> Self:
        """Create a Distillation for the given Memory using the LLM and DISTILLATION prompt."""
